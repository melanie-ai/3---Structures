...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "goran", email: "nesto", age: 17)
...
var me = User(userName: "goran", email: "goran.brlas@gmail.com", age:  17)
User.currentUser = me

var secondUser = User(userName: "ivan", email: "ivan@gmail.com", age: 10)
